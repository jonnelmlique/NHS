<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectModule.aspx.cs" Inherits="lms.sis.SISPAGES.SubjectModule" %>
  ...
  <span class="d-flex">
    ...
    <div class="col-lg-9 bg-white">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <p class="inter-700 text-uppercase">Navigation > Subject Module</p>
                </div>
             ...
             <form id="form1" runat="server">
                <div class="col-lg-8 mb-5 mt-5">
                    <div class="input-group border-gray border shadow">
                        ...
                        <asp:TextBox ID="txtScMsearch" runat="server" CssClass="bg-gray border-none border-0 px-2 " style="resize: none; width: 90%; outline: none"></asp:TextBox>
                        <span class="input-group-append">
                        <%--    <button class="btn bg-white ms-n3 border-gray" type="button">--%>
                                <asp:Button ID="SubMsearch" runat="server" CssClass="btn bg-white ms-n3 border-gray" OnClick="SubMsearch_Click" />
                ...
                <br />
                  ...
                  <div class="row text-uppercase mt-2">
                    <div class="col-lg-6 d-flex">
                        <span class="justify-self-center align-self-center">Strand</span>
                      <%--  <input type="text" class="form-control w-100 mx-2" id="name" name="name" />--%>
                         <asp:DropDownList ID="SMstrand" runat="server" CssClass="form-control w-100 mx-2" OnSelectedIndexChanged="SMstrand_SelectedIndexChanged" AutoPostBack="True">
                         </asp:DropDownList>
                    </div>
                    <div class="col-lg-6 d-flex">
                        <span class="justify-self-center align-self-center">Semester</span>
                        <%--<select class="form-control w-100 mx-2" id="role" name="role"></select>--%>
                        <asp:DropDownList ID="sem" runat="server" CssClass="form-control w-100 mx-2" OnSelectedIndexChanged="CRstrand_SelectedIndexChanged" AutoPostBack="True">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox class="form-control" ID="subjectTitle" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label for="description">description</label>
                                    <asp:TextBox class="form-control" ID="description" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label for="subjectUnit">subjectUnit</label>
                                    <asp:TextBox class="form-control" ID="subjectUnit" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label for="subcode">Subject For</label>
                                    <div class="d-flex">
                                        <asp:TextBox class="form-control w-50 mr-2" ID="subcode" runat="server" ReadOnly="True"></asp:TextBox>
                                        <asp:TextBox class="form-control w-50" ID="semester" runat="server" ReadOnly="True"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary mt-2 px-4" data-dismiss="modal">Cancel</button>
                                <asp:Button ID="SubMadd" runat="server" Text="Save" CssClass="btn btn-success mt-2 px-4" OnClick="SubMadd_Click" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div align="right" class="text-uppercase">
                 <button id="open" type="button" class="btn btn-primary mt-2 px-4" data-toggle="modal" data-target="#myModal" onclick="changeText();">Add A New Subject</button>
            </div>
            </div>
            <br />
       ...
       <div class="gridContainer">
           <asp:GridView CssClass="Grid" ID="Grid" runat="server" CellPadding="30" ForeColor="#333333" GridLines="None" Height="148px" Width="100%" SelectedRowStyle-BackColor="#6666FF"
               CellSpacing="10" Font-Size="Medium" HorizontalAlign="Center" AutoGenerateSelectButton="False" DataKeyNames="number" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowEditing="Grid_RowEditing"
               OnRowUpdating="Grid_RowUpdating" OnRowDeleting="Grid_RowDeleting" OnRowCancelingEdit="Grid_RowCancelingEdit">
    ...
    <script type="text/javascript">
        function changeText() {
            var subcodeTextBox = document.getElementById('<%= subcode.ClientID %>');
                var semesterTextBox = document.getElementById('<%= semester.ClientID %>');
                subcodeTextBox.value = document.getElementById("SMstrand").value;
                semesterTextBox.value = document.getElementById("sem").value;
            }
    </script>
</htm>
