<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SectionManagement.aspx.cs" Inherits="lms.sis.SISPAGES.SectionManagement" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Secton Management</title>
   ...
   <%--      <a href="Maintenance.aspx" class="card card-body bg-pink p-2 w-100 mt-2 text-decoration-none text-black">
    ...
    <div class="col-lg-9 bg-white">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <p class="inter-700 text-uppercase">Navigation > Section Management</p>
                </div>
             ...
             <form id="form1" runat="server">
                <div class="col-lg-8 mb-5">
                    <div class="input-group border-gray border shadow">
                        ...
                        <asp:TextBox ID="txtScMsearch" runat="server" CssClass="bg-gray border-none border-0 " Style="resize: none;height:40px; width: 90%; outline: none"></asp:TextBox>
                        <span class="input-group-append">
                        <%--    <button class="btn bg-white ms-n3 border-gray" type="button">--%>
                                <asp:Button ID="ScMsearch" runat="server" CssClass="btn bg-transparent ms-n3 border-gray position-absolute"  OnClick="ScMsearch_Click" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="18" height="40" style="margin-bottom: 4px">
            ...
            <div class="card card-body border-gray inter-700" style="background-color: var(--bs-gray-300)">
                ...
                <div class="col-lg-6 text-uppercase">
                    Section
                 <%--   <select class="form-control w-100" id="section" name="section"></select>--%>
                 <%--     <asp:DropDownList ID="section" runat="server" CssClass="form-control w-100">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem>test section 1</asp:ListItem>
                        <asp:ListItem>test section 2</asp:ListItem>
                    </asp:DropDownList>--%>
                    <asp:TextBox ID="txtsec" runat="server" CssClass="form-control w-100"></asp:TextBox>
                </div>

                <div class="col-lg-6 text-uppercase">
                    Classroom
                        <%--<select class="form-control w-100" id="classroom" name="classroom"></select>--%>
                 <%--     <asp:DropDownList ID="room" runat="server" CssClass="form-control w-100">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem>test room 1</asp:ListItem>
                        <asp:ListItem>test room 2</asp:ListItem>
                    </asp:DropDownList>--%>
                    <asp:TextBox ID="txtroom" runat="server" CssClass="form-control w-100"></asp:TextBox>
                </div>
            ...
            <div align="right" class="text-uppercase">
                 ...
                 <asp:Button ID="ScMadd" runat="server" Text="Add" CssClass="btn btn-success mt-2 px-4" OnClick="ScMadd_Click" />
             <%--   <button type="submit" class="btn btn-success mt-2 px-4">Update</button>--%>
                <asp:Button ID="ScMupdate" runat="server" Text="Update" CssClass="btn btn-success mt-2 px-4" OnClick="ScMupdate_Click" />
              <%--  <button type="submit" class="btn btn-danger mt-2 px-4">Cancel</button>--%>
                 <asp:Button ID="ScMdelete" runat="server" Text="Delete" CssClass="btn btn-danger mt-2 px-4" OnClick="ScMdelete_Click" OnClientClick="return confirm('Are You Sure You Want To Delete, This Action Cannot Be Undone')" />
                <asp:Button ID="Sccancel" runat="server" Text="Cancel" CssClass="btn btn-danger mt-2 px-4" OnClick="Sccancel_Click" />
            </div>
            </div>
         ...
         <div class="gridContainer">
             <asp:GridView CssClass="Grid" ID="Grid" runat="server" CellPadding="30" ForeColor="#333333" GridLines="None" Height="148px" Width="100%" SelectedRowStyle-BackColor="#6666FF" CellSpacing="10" Font-Size="Medium" HorizontalAlign="Center" AutoGenerateSelectButton="True" DataKeyNames="SectionID" OnSelectedIndexChanged="Grid_SelectedIndexChanged">
